...
if __name__ == '__main__':
    ...
    decrypted = FOSdec.decrypt_save_file(savData)
    with open(file + '.json', 'w', encoding='utf-8') as jsonData:
        jsonData.write(decrypted)
    
    # load data from the vault   /// sys.arv[0]
    vaultData = json.load(decrypted)
